...
You can see [go-mysql-elasticsearch](https://github.com/soglad/go-mysql-elasticsearch) for how to sync MySQL data into Elasticsearch.
...
```go
import (
    "github.com/soglad/go-mysql/server"
    "net"
)
